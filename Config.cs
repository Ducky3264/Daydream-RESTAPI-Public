...
namespace IDSEmpty
{
    ...
    ClientSecrets = { new Secret("Redacted") },
    RequireClientSecret = false,
    RedirectUris =           { "daydream://redirect/oauth" },
    PostLogoutRedirectUris = { "app.example.com" },
    FrontChannelLogoutUri =    "app.example.com/signout-oidc",
